...
class LoadScreen:  # multiple IP or RTSP cameras
    def __init__(self, num_screen=2, img_size=640):
        ...
        self.cap.display = self.cap.displays[self.num_screen-1] # the counting method is different for d3dshot
        ...
        print(' success recording screen:', self.num_screen,'(',sz[0],',',sz[1],') of',self.cap.display)
    ...
    def __next__(self):
        ...
        img0 = letterbox(self.image_cap, new_shape=self.img_size)[0] #reshape to img_size, default 1024
        img = np.ascontiguousarray(img0[:, :, ::-1].transpose(2, 0, 1))
        # print(img.shape)

        
        ###################uncomment this to have output
